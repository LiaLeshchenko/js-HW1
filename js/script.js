...
const lightbox = document.querySelector(".js-box");
const lightboxImage = document.querySelector(".box__image");
const closeBtn = document.querySelector('[data-action="close-box"]');
